package models.RedRibbonHQ_Boss;
...
public class RobotVeSi extends Boss {
    ...
    public RobotVeSi(Zone zone, int id, int dame, int hp) throws Exception {
        super(BossID.ROBOT_VE_SI - id, new BossData(
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(100, 100)) {
            ...
            ItemMap it = new ItemMap(this.zone, 1837, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, it);
        }
    }
