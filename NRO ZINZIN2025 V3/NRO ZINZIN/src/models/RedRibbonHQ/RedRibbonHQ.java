...
import models.RedRibbonHQ_Boss.NinjaAoTim;
import models.RedRibbonHQ_Boss.RobotVeSi;
import models.RedRibbonHQ_Boss.TrungUyThep;
import models.RedRibbonHQ_Boss.TrungUyTrang;
import models.RedRibbonHQ_Boss.TrungUyXanhLo;
...
//             e.printStackTrace();
    ...
    private void init() {
        ...
        ThreadPoolManager.EXECUTOR.submit(this, "Doanh Trại: " + this.clan.name);
    }
