...
public class SoiHecQuyn extends Boss {
    ...
    private boolean ZINZIN_KiemTraNhatXuong = false;
    private long ZINZIN_ThoiGianNhatXuong = 0;
    private long lastTimRestPawn;

    public SoiHecQuyn() throws Exception {
        super(BossID.SOI_HEC_QUYN_1 , BossesData.SOI_HEC_QUYN_1);
    }
    ...
    public void joinMap() {
        if (zoneFinal != null) {
            ...
            this.ZINZIN_ThoiGianNhatXuong = 0;
            this.ZINZIN_KiemTraNhatXuong = false;
            return;
        }
    ...
    public void NhatXuong() {
        ZINZIN_KiemTraNhatXuong = true;
        ZINZIN_ThoiGianNhatXuong = System.currentTimeMillis();

    }

    public boolean ZINZIN_KiemTraNhatXuong() {
        return ZINZIN_KiemTraNhatXuong;
    }
    ...
    public void attack() {
        if (Util.canDoWithTime(this.lastTimeAttack, 100)) {
            ...
            try {
                ...
                if (ZINZIN_ThoiGianNhatXuong > 0) {
                    if (Util.canDoWithTime(ZINZIN_ThoiGianNhatXuong, 5000)) {
                        ZINZIN_ThoiGianNhatXuong = 0;
                        ZINZIN_KiemTraNhatXuong = false;
                    }
                }
            } catch (Exception ex) {
            }
