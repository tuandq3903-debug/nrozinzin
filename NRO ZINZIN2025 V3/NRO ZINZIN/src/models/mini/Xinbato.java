...
public class Xinbato extends Boss {
    ...
    private boolean ZINZIN_Check = false;
    private long ZINZIN_1 = 0;
    private long lastTimRestPawn;

    public Xinbato() throws Exception {
        super(BossID.XINBATO_1 , BossesData.XINBATO_1);
    }
    ...
    public void NhatXuong1() {
        ZINZIN_Check = true;
        ZINZIN_1 = System.currentTimeMillis();

    }

    public boolean ZINZIN_Check() {
        return ZINZIN_Check;
    }
...
public void attack() {
    if (Util.canDoWithTime(this.lastTimeAttack, 100)) {
        ...
        try {
            ...
            if (ZINZIN_1 > 0) {
                if (Util.canDoWithTime(ZINZIN_1, 5000)) {
                    ZINZIN_1 = 0;
                    ZINZIN_Check = false;
                }
            }
