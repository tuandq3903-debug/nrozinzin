...
public void reward(Player plKill) {
    ...
    // --- Thêm: 15% cơ hội rơi trứng đệ (template ID = 1853) ---
    if (Util.isTrue(5, 100)) {
        ItemMap egg = new ItemMap(
            zone,
            1853,  // ID của trứng đệ
            1,
...
//                 ex.printStackTrace();
    ...
    public void rest() {
        ...
        if (percent <= 100) {
            Service.gI().SendMabu(this.zone,this.percent);
        }
    }
