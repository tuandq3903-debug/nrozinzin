...
public class BossID {
    ...
    public static final int TEST_DAME = 377;
    public static final int BA_CON_SOI = 378;
    
    //========================MINI BOSS========================
    public static final int SOI_HEC_QUYN_1 = -667;
    public static final int O_DO_NEW = -668;
    public static final int XINBATO_1 = -669;
    public static final int AN_TROM = -673;
    //========================BOSS BAOTRI========================
    public static final int SU = -670;
    public static final int MAI = -671;
    public static final int FILAP = -672;
}
