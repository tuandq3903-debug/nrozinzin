...
public class BossesData {
    ...
    public static final BossData PIC = new BossData(
            ...
            (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO, FULL_TDHS), // skill
    ...
    public static final BossData POC = new BossData(
            ...
            new int[]{75000000}, // hp
            new int[]{97, 98, 99}, // map join
            (int[][]) Util.addArray(FULL_KAMEJOKO, FULL_TDHS), // skill
            new String[]{}, // text chat 1
    ...
    public static final BossData KING_KONG = new BossData(
            ...
            new int[]{80000000}, // hp
            new int[]{97, 98, 99}, // map join
            (int[][]) Util.addArray(FULL_LIENHOAN, FULL_MASENKO, FULL_TDHS), // skill
            new String[]{}, // text chat 1
    ...
    public static final BossData RONG_1_SAO = new BossData(
            ...
            new String[]{}, // text chat 1
            new String[]{"|-1|Ngọc Rồng ZINZIN"}, // text chat 2
            new String[]{}, // text chat 3
    ...
    public static final BossData CHILLER = new BossData(
            ...
            new String[]{"|-1|Mọi chuyện chưa kết thúc đâu",
                ...
                "|-1|Ngọc Rồng ZINZIN"}, //text chat 3
            REST_30_M //second rest
    );
    ...
    public static final BossData TEST_DAME = new BossData(
            "Tâm Ma", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1544, 1547, 1548, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            5000000, // dame
            new int[]{2_000_000_000}, // hp
            new int[]{42,43,44}, // map join
            new int[][]{},
            new String[]{"|-1|Nhào vô oánh anh đi em"}, // text chat 1
            new String[]{"|-1|Còn non và xanh lắm cu"}, // text chat 2
            new String[]{"|-1|Bơi hết vào đây , anh đây cân hết"}, // text chat 3
            REST_1_M // type appear
    );
    ...
    public static final BossData FILAP = new BossData(
            "Filap", //name
            ConstPlayer.TRAI_DAT, //gender
...
//    public static final BossData O_DO_1 = new BossData(
//            "Ở dơ", //name
//            ConstPlayer.TRAI_DAT, //gender
//            new short[]{400, 401, 402, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
//            3000, //dame
...
//                44, 45, 46, 47, 63, 64, 65, 66, 67, 68, 69, 70, 71,
//                72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84}, //map join
//            (int[][]) Util.addArray(FULL_KAMEJOKO, FULL_GALICK), //skill
//            new String[]{}, //text chat 1
//            new String[]{}, //text chat 2
//            new String[]{}, //text chat 3
