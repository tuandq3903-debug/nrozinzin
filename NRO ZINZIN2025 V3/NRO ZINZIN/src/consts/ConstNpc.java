...
public class ConstNpc {
    ...
    public static final byte GOHAN_BEAST = 85;
    public static final byte HANG_NGA = 81;
    public static final byte TIEM_BANH = 86;
    //----------------------index menu------------------------------------------
    ...
    public static final int MENU_START_COMBINE = 900;
    ...
    public static final int MENU_QUICK_COMBINE = 901;
    public static final int NHAP_NGOC_RONG        = 902;
    ...
    public static final byte DOI_NGOC          = 101;  // ID cho menu “Đổi ngọc”
    public static final byte DOI_NGOC_XANH     = 102;  // ID cho submenu “Chọn mức đổi ngọc xanh”
    public static final byte DOI_NGOC_HONG     = 103;  // ID cho submenu “Chọn mức đổi ngọc hồng”
    public static final byte DOI_THANHLINH     = 104;
    public static final byte DOI_DE      = 105;
    public static final byte MENU_BOT      = 106;
    ...
    public static final int OTHER_MENU = 600;
    ...
    public static final int HOP_QUA_SKH = 251003;
    
    public static final int HOP_QUA_THAN_LINH = 251000;
    
    public static final int HOP_QUA_HUY_DIET = 251001;
    
    public static final int HOP_QUA_THIEN_SU = 251002;
    
    
    public static final int MENU_BANH_TRUNG_THU = 251008;
    
    public static final int MENU_BANH_TRUNG_THU_2 = 251009;
    
    public static final int MENU_HOP_TRUNG_THU = 251010;
    
    public static final int MENU_HOP_TRUNG_THU_2 = 251011;
    ...
    public static final int BANG_XEP_HANG = 1939392;
    ...
    public static final int MENU_SHOW = 9999880;
    public static final int MENU_HV_EVENT = 5000;
    public static final int MENU_HV_PLAYER = 6000;
}
